  ...
  return (
    <Grid container spacing={3}>
      ...
      <CompanyDetail
        ...
        companyDetails={[
          { label: 'Contact Person 01', value: contactPerson, option: 'odd' },
          { label: 'E-mail Address 01', value: contactEmail, option: 'even' },
          { label: 'Phone Number 01', value: contactNumber, option: 'odd' },
          { label: 'Contact Person 02', value: secondaryContactPerson, option: 'even' },
          { label: 'E-mail Address 02', value: secondaryContactEmail, option: 'odd' },
          { label: 'Phone Number 02', value: secondaryContactNumber, option: 'even' }
        ]}
      />
    </Grid>
  );
