...
const ToolBar: FC<Props> = props => {
  ...
  const { isProcessing, clients, entities, checked, setOpenDialog, setMessage } = props;
  ...
  const renderRightHeader = () => {
    ...
    if (countChecked !== 0) {
      ...
      return (
        <Fragment>
          <SearchInput withBorder withTransition={false} width={150} placeHolder='Search Contracts...' iconColor='#989898' />
          <PositionedPopper
            ...
            options={[{ key: 'termStart', label: 'Start Date' }, { key: 'termEnd', label: 'End Date' }]}
            filterBy={filterBy}
          ...
          <PositionedPopper
            ...
            options={[{ key: 'clientId', label: 'Client', checkBoxList: clients }, { key: 'entityId', label: 'Entity', checkBoxList: entities }]}
            columnFilter={columnFilter}
